...
def schedule_monthly_survey():
    ...
    scheduler.add_job(send_survey_to_all, 'cron', day=26, hour=9, minute=0)
    scheduler.add_job(send_survey_to_all, 'cron', day=26, hour=10, minute=0)
    scheduler.add_job(cache_questions, 'cron', day=26, hour=9, minute=0)
    scheduler.add_job(send_survey_to_all, 'cron', day=26, hour=11, minute=0)
    scheduler.add_job(cache_questions, 'cron', day=26, hour=10, minute=0)
    ...
    scheduler.add_job(send_survey_to_all, 'cron', day=26, hour=1, minute=0)
    scheduler.add_job(cache_questions, 'cron', day=26, hour=11, minute=0)
    scheduler.add_job(send_survey_to_all, 'cron', day=27, hour=12, minute=0)
    scheduler.add_job(cache_questions, 'cron', day=27, hour=11, minute=0)
    scheduler.add_job(send_survey_to_all, 'cron', day=28, hour=12, minute=0)
    scheduler.add_job(cache_questions, 'cron', day=28, hour=11, minute=0)
